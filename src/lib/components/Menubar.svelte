...
<style lang="postcss">
	...
	.item {
		...
		@apply z-20 text-slate-900 outline-none;
	...
	.trigger {
		...
		@apply text-slate-900 transition-colors hover:bg-white/90 data-[highlighted]:outline-none;
		@apply overflow-visible data-[highlighted]:bg-slate-200 data-[highlighted]:ring-slate-400 !important;
	...
	.dot {
		@apply h-[4.75px] w-[4.75px] rounded-full bg-slate-900;
	}

	.separator {
		@apply m-[5px] h-[1px] bg-slate-200;
	}
